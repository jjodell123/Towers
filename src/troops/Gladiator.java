...
public class Gladiator extends Troop{
	...
	public Gladiator(int x,int y, int size,int speed,int damage,int health,int attackSpeed,int team)
	{
		super(x,y,size,speed,damage,health,attackSpeed,team);
		super.setType("Gladiator");
